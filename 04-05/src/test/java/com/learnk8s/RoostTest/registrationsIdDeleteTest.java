...
public class registrationsIdDeleteTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/learnk8s/RoostTest/registrations_idDeleteTest.csv", envVarsList);
    }

  
    @Test  
    public void registrationsIdDelete_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              ...
              System.out.printf("Test Case %d: registrationsIdDelete_Test \n", testNumber++);
              System.out.println("Request: DELETE /registrations/{id}");
